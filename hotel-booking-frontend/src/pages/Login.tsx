        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="hidden lg:flex flex-col items-center justify-center">
            ...
            <div className="relative w-72 h-72 mb-8">
              {/* Outer Gradient Ring */}
              <div className="absolute inset-0 rounded-full bg-gradient-to-br from-cyan-400 via-blue-400 to-blue-600 p-2">
                {/* Inner White Space */}
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 max-w-sm">
                Sign in to access your bookings, manage your hotels, and explore amazing destinations.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-8">
            ...
            <Card className="relative overflow-hidden border-0 shadow-2xl bg-white/95 backdrop-blur-sm">
              ...
              <CardHeader className="text-center relative z-10 pb-8">
                <div className="mx-auto w-16 h-16 bg-gradient-to-br from-primary-500 to-primary-600 rounded-2xl flex items-center justify-center mb-4 shadow-lg lg:hidden">
                  <LogIn className="w-8 h-8 text-white" />
                </div>
                <CardTitle className="text-3xl font-bold text-gray-900 mb-2 lg:text-left">
                  Sign In
                </CardTitle>
                <CardDescription className="text-gray-600 lg:text-left">
                ...
                {!import.meta.env.PROD && (
                  <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg text-left">
                    <p className="text-sm text-yellow-800">
                      ...
                      persists between sessions. Use the "Clear Auth" button in
                      the header to reset.
                    </p>
                  </div>
                )}
